    ...
    return (
        <div>
            <div className='flex  justify-between mb-20'>
                ...
                <div className='p-4 rounded-lg border-2 px-4 cursor-pointer transition-all text-[#4540E1] hover:text-white ease-in-out duration-200 border-[#4540e11f] hover:bg-[#4540E1]'>
