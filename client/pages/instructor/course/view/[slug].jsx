                    ...
                    <div className="flex">
                        <div className="flex flex-col items-center">
                            ...
                            <div className="flex mt-48 items-center">
                                <div className="bg-red-400 flex p-2 justify-center items-center rounded-lg">
                                    <span className="text-white font-semibold">
                                        Edit
                                    </span>
                                    <FiEdit3 onClick={() => router.push(`/instructor/course/edit/${slug}`)} title="Edit" className="text-[18px] ml-2 cursor-pointer text-white" />
                                </div>
                                <div className="bg-green-400 flex p-2 justify-center items-center rounded-lg ml-16">
                                    <span className="text-white font-semibold">
                                        Publish
                                    </span>
                                    <MdOutlinePublishedWithChanges title="Publish" className="text-[18px] ml-2 cursor-pointer text-white" />
                                </div>
                            </div>
                        </div>
                        <div className="mx-10">
                                ...
                                <div className="mt-4">
                                    {course && course.lessons && course.lessons.map((lesson, index) => (
                                        <div className="p-2 flex justify-between items-center" key={index}>
                                            <div className="flex items-center cursor-pointer" onClick={() => setShowVideoModal(true)}>
